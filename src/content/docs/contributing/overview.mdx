...
- apps/
  ...
  - isekai-publisher/ Background Worker. Processes queues (uploading to DA, cleaning R2).
- packages/
...
3. **Environment Variables**
   ...
   <Aside type="note">
   You must fill in the `DEVIANTART_CLIENT_ID` and R2 credentials in `apps/isekai-backend/.env` for the app to function fully.
   </Aside>
